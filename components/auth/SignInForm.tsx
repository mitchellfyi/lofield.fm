...
export function SignInForm() {
  const githubEnabled = process.env.NEXT_PUBLIC_SUPABASE_AUTH_GITHUB_ENABLED === "true";
  const googleEnabled = process.env.NEXT_PUBLIC_SUPABASE_AUTH_GOOGLE_ENABLED === "true";
    ...
    <div className="w-full max-w-md mx-auto p-6">
      ...
      {(githubEnabled || googleEnabled) && (
        <>
          ...
          <div className={githubEnabled && googleEnabled ? "grid grid-cols-2 gap-3" : "grid gap-3"}>
            {githubEnabled && (
              <button
