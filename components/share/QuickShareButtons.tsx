  ...
  return (
    <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-2 duration-300">
      ...
      <button
        ...
        className="flex items-center justify-center gap-1.5 px-3 py-2.5 min-h-11 rounded-sm text-sm font-medium bg-[#1DA1F2]/10 border border-[#1DA1F2]/30 text-[#1DA1F2] hover:bg-[#1DA1F2]/20 hover:border-[#1DA1F2]/50 transition-all duration-200 backdrop-blur-sm"
      ...
      <button
        ...
        className={`flex items-center justify-center gap-1.5 px-3 py-2.5 min-h-11 rounded-sm text-sm font-medium transition-all duration-200 backdrop-blur-sm ${
          copied
